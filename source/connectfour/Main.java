...
public class Main extends Application
{
    ...
    private void aboutMe()
    {
        ...
        alert.setHeaderText("Bhavya Bhagwani");
        alert.setContentText("I am Bhavya Bhagwani, a highly motivated and" +
                "  versatile tech enthusiast with a passion for software" +
                "development. Skilled in full-stack development" +
                "with a solid foundation in programming languages like JAVA," +
                "and Python, coupled with Object-oriented programming concepts" +
                " and hands-on experience in front-end and back-end development." +
                "Proficient in communication and collaboration, with profound"+
                "knowledge of Data Structures and Algorithms using Java. ");
